    ...
    <section style={{ padding: '40px 16px 24px' }}>
      <div style={{
        ...
        <div aria-hidden style={{
          ...
          background: 'radial-gradient(circle, rgba(242,107,31,.35) 0%, transparent 65%)',
        }} />
        <div style={{ position: 'relative' }}>
          <div className="hindi" style={{
            display: 'inline-flex', gap: 5, alignItems: 'center',
            background: 'rgba(242,107,31,.18)', color: '#FFB67A',
          ...
          <p className="hindi" style={{ fontSize: 15, color: 'rgba(255,255,255,.75)', lineHeight: 1.5, margin: 0 }}>
            {copy.finalCtaSub}
          </p>
          ...
          <div style={{ marginTop: 10, fontSize: 11, color: 'rgba(255,255,255,.5)', textAlign: 'center' }}>
            {count}+ students already on waitlist
          </div>
        </div>
      </div>
    </section>
